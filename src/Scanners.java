...
// System.out.print: 이 메소드는 지정된 데이터를 콘솔에 출력하고, 커서를 그대로 둡니다. 즉, 출력 후에 줄바꿈을 하지 않습니다. 1
// System.out.println: 이 메소드는 지정된 데이터를 콘솔에 출력한 후, 커서를 다음 줄로 이동시킵니다. 즉, 출력 후에 자동으로 줄바꿈을 합니다. 2
// 사용 예시
